...
export const metadata: Metadata = {
  title: "AlphaLux Reviews & Projects | 5-Star House Cleaning",
  description:
    "Real 5-star reviews and project results from AlphaLux Cleaning clients in Texas & California. Eco-friendly, non-toxic house cleaning in Dallas, Austin, Beverly Hills & more.",
  alternates: { canonical: `${BASE_URL}/reviews` },
  openGraph: {
    type: "website",
    title: "AlphaLux Reviews & Projects | 5-Star House Cleaning",
    description: "5-star client reviews and project outcomes from AlphaLux — eco-friendly house cleaning across TX & CA.",
...
export default function ReviewsPage() {
  return (
    <>
      ...
      <section className="bg-[#0A0A0A] pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm text-gray-500 mb-6 flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-[#253858]">Reviews &amp; Projects</span>
          </nav>
          <div className="max-w-3xl">
            <p className="text-[#253858] text-xs font-semibold uppercase tracking-[0.2em] mb-3">Client Testimonials &amp; Work</p>
            ...
            <a href={GBP_URL} target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-[#253858] border border-[#253858]/30 rounded-lg px-4 py-2 text-sm hover:bg-[#253858]/10 transition-colors">
      ...
      {/* Rating bar */}
      <section className="bg-[#1A1A1A] border-t border-[#253858]/10 border-b border-[#253858]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-wrap items-center justify-center gap-8 text-center">
            <div>
              <p className="text-[#253858] text-4xl font-bold" style={{ fontFamily: "var(--font-playfair)" }}>5.0</p>
              <p className="text-[#253858] text-lg">★★★★★</p>
              <p className="text-gray-400 text-sm mt-1">Average Rating</p>
            </div>
            <div className="w-px h-12 bg-[#253858]/20 hidden sm:block" />
            <div>
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-[#253858] text-xs font-semibold uppercase tracking-[0.2em] mb-3">Client Testimonials</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {REVIEWS.map((r) => (
              <article key={r.name} className="bg-[#F8F7F4] border border-[#253858]/15 rounded-xl p-7 card-hover">
          ...
          <div className="text-center mt-10">
            <a href={GBP_URL} target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-[#253858] text-[#253858] font-medium px-6 py-3 rounded-lg hover:bg-[#253858]/10 transition-colors text-sm">
      ...
      <section className="bg-[#F8F7F4] py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PROJECTS.map((p) => (
              <article key={p.type + p.city} className="border border-[#253858]/20 rounded-xl p-7 card-hover bg-white">
      ...
      <section className="bg-[#0A0A0A] py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href={PHONE_TEL} className="inline-flex items-center justify-center gap-2 border border-[#253858] text-[#253858] font-medium px-6 py-3.5 rounded-lg hover:bg-[#253858]/10 transition-colors text-sm">
              <Phone className="w-4 h-4" /> Call {PHONE_DISPLAY}
            </a>
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 bg-[#253858] text-[#0A0A0A] font-semibold px-6 py-3.5 rounded-lg hover:bg-[#2C4267] transition-colors text-sm">
