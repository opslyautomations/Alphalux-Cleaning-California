    ...
    <section className="bg-white pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="text-sm text-gray-500 mb-6 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-[#C9A961]">Terms of Service</span>
        </nav>
        ...
        <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-6">
          ...
          <p>Questions? Contact us at <a href={EMAIL_MAILTO} className="text-[#C9A961] hover:underline">{EMAIL}</a> or <a href={PHONE_TEL} className="text-[#C9A961] hover:underline">{PHONE_DISPLAY}</a>.</p>
        </div>
      </div>
    </section>
  );
