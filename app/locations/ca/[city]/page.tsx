...
export async function generateMetadata({ params }: { params: Promise<{ city: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Non-toxic house cleaning in ${data.name}, CA. Licensed & insured. Free quote. Same-week availability from AlphaLux Cleaning.`,
      ...
      <section className="bg-[#0A0A0A] pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-[#253858] text-xs font-semibold uppercase tracking-[0.2em] mb-2">California</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <a href={CA_PHONE_TEL} className="inline-flex items-center justify-center gap-2 bg-[#253858] text-[#0A0A0A] font-semibold px-6 py-3.5 rounded-lg hover:bg-[#2C4267] transition-colors text-sm">
                  <Phone className="w-4 h-4" /> Call {CA_PHONE_DISPLAY}
                </a>
              </div>
              <div className="flex flex-col gap-2 text-sm text-gray-400">
                <span className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-[#253858]" />Licensed &amp; Insured in California</span>
