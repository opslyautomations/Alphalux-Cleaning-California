...
export async function generateMetadata({ params }: { params: Promise<{ city: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Eco-friendly, non-toxic house cleaning in ${data.name}, Texas. Licensed & insured. From $99/visit. AlphaLux Cleaning serves ${data.name} with same-week availability.`,
      ...
      <section className="bg-[#0A0A0A] pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-[#C9A961] text-xs font-semibold uppercase tracking-[0.2em] mb-2">Texas</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="flex flex-col gap-2 text-sm text-gray-400">
                <span className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-[#C9A961]" />Licensed &amp; Insured in Texas</span>
